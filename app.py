...
DROPBOX_APP_KEY = 'jyu5031v2rkzfr4'
DROPBOX_APP_SECRET = 'ni1uvt1lfe2z3cw'
DROPBOX_REFRESH_TOKEN = 'VamoWRdx9ZMAAAAAAAAAATjPyvEifHg21QEXaFJ1z_nKPXuXSE4CXKDIEDKHY9lH'
DROPBOX_FOLDER = '/videos'
VIDEO_PROGRESS_FILE = os.path.join(DATA_DIR, 'video_progress.json')
VIDEO_DAILY_FILE = os.path.join(DATA_DIR, 'video_daily.json')
DROPBOX_SPACES_FILE = os.path.join(DATA_DIR, 'dropbox_spaces.json')
VIDEO_PUBLISH_TRACKER_FILE = os.path.join(DATA_DIR, 'video_publish_tracker.json')
_dropbox_access_token = {'token': '', 'expires': 0}

def get_dropbox_token():
    """الحصول على access token صالح عبر refresh token"""
    import time as _time
    global _dropbox_access_token
    if _dropbox_access_token['token'] and _time.time() < _dropbox_access_token['expires'] - 300:
        return _dropbox_access_token['token']
    try:
        ...
        if 'access_token' in data:
            _dropbox_access_token['token'] = data['access_token']
            _dropbox_access_token['expires'] = _time.time() + data.get('expires_in', 14400)
            logger.info("Dropbox token refreshed OK")
...
POST_CATEGORIES = {
    ...
    '🎬 فيديو من المكتبة':         ['🎬 فيديو من المكتبة'],
...
SCHEDULE_TEMPLATES = {
    "📖 جدول القرآن": {
        "desc": "قرآن وتفسير + 5 فيديوهات — 12 بوست يومياً",
        "hours": [
            (6,  "🤲 الأذكار والأدعية"),
            (7,  "🎬 فيديو من المكتبة"),
            (9,  "📖 القرآن الكريم"),
            (11, "📚 الفقه والعلم الشرعي"),
            (12, "🎬 فيديو من المكتبة"),
            (13, "📖 القرآن الكريم"),
            (15, "🎬 فيديو من المكتبة"),
            (17, "✈️ رحلات إسلامية"),
    ...
    "⚔️ جدول البطولات": {
        "desc": "سيرة وفتوحات + 5 فيديوهات — 12 بوست يومياً",
        "hours": [
            (6,  "🔢 سلاسل يومية"),
            (8,  "🎬 فيديو من المكتبة"),
            (9,  "🕌 السيرة النبوية"),
            (11, "👳 قصص الأنبياء"),
            (13, "🎬 فيديو من المكتبة"),
            (14, "⚔️ فتوحات ومعارك الإسلام"),
            (16, "🌟 قصص الصحابة"),
            (17, "🎬 فيديو من المكتبة"),
            (19, "🧠 الحضارة الإسلامية"),
            (20, "🎬 فيديو من المكتبة"),
            (21, "🌹 نساء الإسلام"),
            (22, "🎬 فيديو من المكتبة"),
        ]
    ...
    "🤲 جدول الروحانيات": {
        "desc": "أذكار وأدعية وقصص + 5 فيديوهات — 12 بوست يومياً",
        "hours": [
            (5,  "🤲 الأذكار والأدعية"),
            (7,  "🎬 فيديو من المكتبة"),
            (9,  "😢 قصص إيمانية مؤثرة"),
            (11, "🤲 أدعية قصيرة مؤثرة"),
            (12, "🎬 فيديو من المكتبة"),
            (14, "💫 قصص من الحياة اليومية"),
            (16, "🎬 فيديو من المكتبة"),
            (18, "💎 الأخلاق والتزكية"),
            (19, "🎬 فيديو من المكتبة"),
            (20, "💌 رسائل إيمانية"),
            (21, "🤲 أدعية قصيرة مؤثرة"),
            (23, "🎬 فيديو من المكتبة"),
        ]
    },
    "💡 جدول التحفيز": {
        "desc": "تحفيز وتطوير ذات + 5 فيديوهات — 12 بوست يومياً",
        "hours": [
            (7,  "🔥 تحفيز وإلهام"),
            (8,  "🎬 فيديو من المكتبة"),
            (9,  "🧠 تطوير الذات"),
    ...
    "📚 جدول العلم": {
        "desc": "فقه وعلم شرعي + 5 فيديوهات — 12 بوست يومياً",
        "hours": [
            (6,  "📖 القرآن الكريم"),
            (7,  "🎬 فيديو من المكتبة"),
            ...
            (11, "💬 تفاعلي وجذاب"),
            (13, "🎬 فيديو من المكتبة"),
            (14, "📚 الفقه والعلم الشرعي"),
            (16, "⚡ محتوى صادم ومثير"),
            (17, "🎬 فيديو من المكتبة"),
            (18, "🌍 الإسلام في العالم"),
            (20, "🎬 فيديو من المكتبة"),
            (21, "📚 الفقه والعلم الشرعي"),
            (22, "🎬 فيديو من المكتبة"),
        ]
    },
    "🌙 جدول المتنوع": {
        "desc": "كل الفئات بتوازن + 5 فيديوهات — 12 بوست يومياً",
        "hours": [
            (7,  "🎬 فيديو من المكتبة"),
            (8,  "📖 القرآن الكريم"),
            (9,  "🕌 السيرة النبوية"),
    ...
    "💰 جدول المال والتطوير": {
        "desc": "مالي وتطوير ذات + 5 فيديوهات — 12 بوست يومياً",
        "hours": [
            (7,  "🧠 تطوير الذات"),
            (8,  "🎬 فيديو من المكتبة"),
            (9,  "💰 مالي وعملي"),
...
def add_log(page_name, status, message, post_type=''):
    ...
    # تسجيل في Analytics
    if post_type:
        record_analytics(page_name, post_type, status == 'success', now.hour, now.weekday())

def record_analytics(page_name, post_type, success, hour, weekday):
    analytics = load_json(ANALYTICS_FILE, {})
    key = f"{hour}_{weekday}"
    if key not in analytics:
        analytics[key] = {'hour': hour, 'weekday': weekday, 'success': 0, 'fail': 0, 'total': 0}
    analytics[key]['total'] += 1
    if success:
        analytics[key]['success'] += 1
    else:
        analytics[key]['fail'] += 1
    # تسجيل حسب الصفحة
    page_key = f"page_{page_name}_{hour}"
    if page_key not in analytics:
        analytics[page_key] = {'page': page_name, 'hour': hour, 'success': 0, 'fail': 0, 'total': 0}
    analytics[page_key]['total'] += 1
    if success:
        analytics[page_key]['success'] += 1
    else:
        analytics[page_key]['fail'] += 1
...
def load_dropbox_spaces():
    """تحميل كل مساحات Dropbox المضافة"""
    spaces = load_json(DROPBOX_SPACES_FILE, [])
    # أضف المساحة الأساسية لو موجودة
    main = {
        'id': 'main',
    ...
    # تحقق أن المساحة الرئيسية موجودة
    if DROPBOX_REFRESH_TOKEN and not any(s.get('id') == 'main' for s in spaces):
        spaces.insert(0, main)
    elif DROPBOX_REFRESH_TOKEN:
        spaces[0] = {**spaces[0], **main}
    return spaces

def get_space_token(space):
    """الحصول على access token لمساحة معينة"""
    import time as _t
    cache = space.get('_token_cache', {'token': '', 'expires': 0})
    if cache.get('token') and _t.time() < cache.get('expires', 0) - 300:
        return cache['token']
    try:
        r = requests.post('https://api.dropbox.com/oauth2/token',
            data={
                ...
                'client_id': space['app_key'],
                'client_secret': space['app_secret']
            }, timeout=15)
        data = r.json()
        if 'access_token' in data:
            space['_token_cache'] = {
                'token': data['access_token'],
                'expires': _t.time() + data.get('expires_in', 14400)
            }
            return data['access_token']
    except Exception as e:
        logger.error(f"Space token error: {e}")
    return ''

def list_videos_from_space(space):
    """جلب فيديوهات من مساحة واحدة"""
    try:
        token = get_space_token(space)
        if not token:
            return []
        folder = space.get('folder', '/videos')
        headers = {'Authorization': f'Bearer {token}', 'Content-Type': 'application/json'}
        r = requests.post('https://api.dropboxapi.com/2/files/list_folder',
            headers=headers,
            json={'path': folder, 'recursive': False, 'limit': 2000},
            timeout=15)
        if r.status_code == 409:
            requests.post('https://api.dropboxapi.com/2/files/create_folder_v2',
                headers=headers, json={'path': folder}, timeout=10)
            return []
        data = r.json()
        files = [f for f in data.get('entries', [])
                 if f.get('.tag') == 'file' and
                 any(f['name'].lower().endswith(ext) for ext in ['.mp4','.mov','.avi','.mkv','.3gp'])]
        files.sort(key=lambda x: x.get('server_modified', ''))
        # أضف معرف المساحة لكل فيديو
        for f in files:
            f['_space_id'] = space.get('id', 'main')
        return files
    except Exception as e:
        logger.error(f"list_videos_from_space error: {e}")
        return []

def delete_video_from_space(space, file_path):
    """حذف فيديو من مساحة معينة"""
    try:
        token = get_space_token(space)
        if not token:
            return False
        headers = {'Authorization': f'Bearer {token}', 'Content-Type': 'application/json'}
        r = requests.post('https://api.dropboxapi.com/2/files/delete_v2',
            headers=headers, json={'path': file_path}, timeout=15)
        if r.status_code == 200:
            logger.info(f"Video deleted from space {space.get('id')}: {file_path}")
            return True
        return False
    except Exception as e:
        logger.error(f"delete_video_from_space error: {e}")
        return False

def list_all_dropbox_videos():
    """جلب كل الفيديوهات من كل المساحات"""
    spaces = load_dropbox_spaces()
    all_videos = []
    for space in spaces:
        videos = list_videos_from_space(space)
        all_videos.extend(videos)
        logger.info(f"Space {space.get('name')}: {len(videos)} videos")
    return all_videos

def get_video_space(file_path):
    """إيجاد المساحة التي ينتمي لها الفيديو"""
    spaces = load_dropbox_spaces()
    for space in spaces:
        folder = space.get('folder', '/videos')
...
def add_dropbox_space(name, app_key, app_secret, refresh_token, folder='/videos'):
    """إضافة مساحة Dropbox جديدة"""
    spaces = load_json(DROPBOX_SPACES_FILE, [])
    ...
    save_json(DROPBOX_SPACES_FILE, spaces)
    return space_id

def list_dropbox_videos():
    """جلب قائمة الفيديوهات من Dropbox"""
    try:
        token = get_dropbox_token()
        if not token:
            logger.error("No Dropbox token available")
            return []
        headers = {'Authorization': f'Bearer {token}', 'Content-Type': 'application/json'}
        r = requests.post('https://api.dropboxapi.com/2/files/list_folder',
            headers=headers,
            json={'path': DROPBOX_FOLDER, 'recursive': False, 'limit': 2000},
            timeout=15)
        if r.status_code == 409:
            # المجلد غير موجود — أنشئه
            requests.post('https://api.dropboxapi.com/2/files/create_folder_v2',
                headers=headers, json={'path': DROPBOX_FOLDER}, timeout=10)
            return []
        data = r.json()
        files = [f for f in data.get('entries', [])
                 if f.get('.tag') == 'file' and
                 any(f['name'].lower().endswith(ext) for ext in ['.mp4','.mov','.avi','.mkv','.3gp'])]
        # ترتيب من القديم للجديد
        files.sort(key=lambda x: x.get('server_modified', ''))
        logger.info(f"Dropbox: {len(files)} videos found")
        return files
    except Exception as e:
        logger.error(f"Dropbox list error: {e}")
        return []

def delete_dropbox_video(file_path):
    """حذف الفيديو من المساحة المناسبة بعد النشر"""
    space = get_video_space(file_path)
    if space:
        return delete_video_from_space(space, file_path)
    return False

def load_video_publish_tracker():
    """تحميل سجل نشر الفيديوهات على الصفحات"""
    return load_json(VIDEO_PUBLISH_TRACKER_FILE, {})

def save_video_publish_tracker(tracker):
    save_json(VIDEO_PUBLISH_TRACKER_FILE, tracker)

def get_all_active_page_ids():
    """إرجاع معرّفات كل الصفحات النشطة التي لديها جدول فيديو"""
    ...
    for p in pages:
        if not p.get('active', True):
            continue
        has_video_slot = any(
            s.get('post_type') == '🎬 فيديو من المكتبة'
...
def mark_video_published_by_page(file_path, page_id):
    """تسجيل أن صفحة معينة نشرت هذا الفيديو"""
    today = datetime.now().strftime('%Y-%m-%d')
    tracker = load_video_publish_tracker()
    key = f"{today}:{file_path}"
    if key not in tracker:
        tracker[key] = {'pages_published': [], 'date': today, 'deleted': False}
    if page_id not in tracker[key]['pages_published']:
        tracker[key]['pages_published'].append(page_id)
    # احتفظ بآخر 3 أيام فقط لتنظيف الملف
    cutoff = (datetime.now() - timedelta(days=3)).strftime('%Y-%m-%d')
    tracker = {k: v for k, v in tracker.items() if v.get('date', '') >= cutoff}
    save_video_publish_tracker(tracker)
    return tracker[key]

def should_delete_video_now(file_path, page_id):
    """هل يجب حذف الفيديو الآن؟ فقط لو نُشر على كل الصفحات"""
    today = datetime.now().strftime('%Y-%m-%d')
    tracker = load_video_publish_tracker()
    key = f"{today}:{file_path}"
    entry = tracker.get(key, {})
    if entry.get('deleted'):
        return False  # تم حذفه مسبقاً
    all_page_ids = get_all_active_page_ids()
    if not all_page_ids:
        return True  # مفيش صفحات بجدول فيديو — احذف فوراً
    published = set(entry.get('pages_published', []))
    remaining = [pid for pid in all_page_ids if pid not in published]
    logger.info(f"Video {file_path}: published by {len(published)}/{len(all_page_ids)} pages. Remaining: {remaining}")
    return len(remaining) == 0

def mark_video_deleted_in_tracker(file_path):
    """تسجيل أن الفيديو تم حذفه"""
    today = datetime.now().strftime('%Y-%m-%d')
    tracker = load_video_publish_tracker()
    key = f"{today}:{file_path}"
    if key in tracker:
        tracker[key]['deleted'] = True
        save_video_publish_tracker(tracker)

def load_video_progress():
    return load_json(VIDEO_PROGRESS_FILE, {})

def save_video_progress(progress):
    save_json(VIDEO_PROGRESS_FILE, progress)

def load_daily_videos():
    data = load_json(VIDEO_DAILY_FILE, {})
    today = datetime.now().strftime('%Y-%m-%d')
    if data.get('date') != today:
        data = {'date': today, 'used_paths': []}
        save_json(VIDEO_DAILY_FILE, data)
    return data

def mark_video_used_today(path):
    data = load_daily_videos()
    if path not in data['used_paths']:
        data['used_paths'].append(path)
        save_json(VIDEO_DAILY_FILE, data)

def get_next_video_from_dropbox(page_id, custom_folder=None):
    """يرجع الفيديو التالي للنشر - مختلف بين الصفحات ولا يتكرر اليوم"""
    try:
        # لو في مجلد مخصص للصفحة
        if custom_folder:
            # ابحث في المساحة التي تحتوي هذا المجلد
            spaces = load_dropbox_spaces()
            videos = []
            for space in spaces:
                orig_folder = space.get('folder', '/videos')
                space['folder'] = custom_folder
                vids = list_videos_from_space(space)
                space['folder'] = orig_folder
                videos.extend(vids)
        else:
            # جلب الفيديوهات من كل المساحات
            videos = list_all_dropbox_videos()
        if not videos:
            return None
        # الفيديوهات المستخدمة اليوم
        daily = load_daily_videos()
        used_today = set(daily.get('used_paths', []))
        # الفيديوهات المتاحة (لم تُنشر اليوم)
        available = [v for v in videos if v.get('path_lower','') not in used_today]
        if not available:
            # كل الفيديوهات نُشرت اليوم — ابدأ من أول
            logger.info("All videos published today, resetting daily tracker")
            save_json(VIDEO_DAILY_FILE, {'date': datetime.now().strftime('%Y-%m-%d'), 'used_paths': []})
            available = videos
        # اختر بناءً على رقم الصفحة في القائمة لضمان الاختلاف
        progress = load_video_progress()
        last_idx = progress.get(page_id, -1)
        # ابحث عن أول فيديو متاح بعد الأخير
        next_video = None
        for i, v in enumerate(available):
            idx = videos.index(v)
            if idx > last_idx:
                next_video = v
                progress[page_id] = idx
                break
        if not next_video:
            next_video = available[0]
            progress[page_id] = videos.index(next_video)
        save_video_progress(progress)
        return next_video
    except Exception as e:
        logger.error(f"get_next_video error: {e}")
        return None

def download_dropbox_video(path):
    """تحميل فيديو من Dropbox مؤقتاً ورفعه"""
    import tempfile
    tmp_path = None
    try:
        headers = {
            'Authorization': f'Bearer {get_dropbox_token()}',
            'Dropbox-API-Arg': json.dumps({'path': path})
        }
        r = requests.post('https://content.dropboxapi.com/2/files/download',
            headers=headers, timeout=120, stream=True)
        if r.status_code != 200:
            logger.error(f"Dropbox download error: {r.status_code}")
            return None
...
def post_video_from_library(page_id, access_token, fb_page_id, topic, personality, custom_folder=None):
    """جلب فيديو من Dropbox ونشره على فيسبوك"""
    if not DROPBOX_REFRESH_TOKEN:
        return False, 'Dropbox Token غير مضبوط'
    video = get_next_video_from_dropbox(page_id, custom_folder)
    if not video:
        return False, 'لا توجد فيديوهات في مجلد Dropbox /videos'
    file_path = video.get('path_lower', '')
    file_name = video.get('name', '')
    logger.info(f"Posting video: {file_name}")
    # توليد تعليق إسلامي متنوع بالـ AI
    settings = load_json(SETTINGS_FILE, {})
    api_key = settings.get('groq_api_key', '').strip()
    caption = "بسم الله الرحمن الرحيم\n\n🤍 " + file_name.rsplit(".",1)[0] + "\n\n#إسلاميات #محتوى_إسلامي #القرآن_الكريم"
    if api_key:
        try:
            p_name = PAGE_PERSONALITIES.get(personality, 'روحاني هادئ')
            clean_name = file_name.rsplit('.', 1)[0].replace('_', ' ').replace('-', ' ')
            # أنواع متنوعة للتعليق الإسلامي
            caption_types = [
                'ابدأ بآية قرآنية كريمة مناسبة ثم اكتب تأملاً مؤثراً',
                'ابدأ بحديث نبوي صحيح مناسب ثم اشرح حكمته',
                'اكتب نصيحة دينية عملية من القرآن أو السنة',
                'اكتب عن رحمة الله وحبه لعباده بأسلوب مؤثر',
                'اكتب حكمة إسلامية عميقة مستوحاة من الفيديو',
                'ابدأ بدعاء مأثور مناسب ثم شجع على التفاعل',
            ]
            cap_type = random.choice(caption_types)
            system_msg = 'أنت كاتب محتوى إسلامي متخصص. اكتب باللغة العربية الفصحى فقط بدون أي حروف أجنبية.'
            prompt = (
                'اكتب تعليقاً إسلامياً مؤثراً لفيديو إسلامي.\n'
                'اسم الفيديو: ' + clean_name + '\n'
                'موضوع الصفحة: ' + topic + '\n'
                'نوع التعليق المطلوب: ' + cap_type + '\n\n'
                'الشروط:\n'
                '- 3-4 أسطر فقط\n'
                '- أضف هاشتاقات إسلامية عربية في النهاية\n'
                '- باللغة العربية الفصحى فقط بدون أي كلمة أجنبية\n'
                '- لا تكتب "التعليق:" أو أي مقدمة'
            )
            ...
            data = r.json()
            if 'choices' in data:
                cap = data['choices'][0]['message']['content'].strip()
                if has_foreign_words(cap):
                    cap = clean_foreign_words(cap)
                if cap and len(cap) > 20:
                    caption = cap
        except Exception as e:
            logger.error(f"Caption error: {e}")
    # تحميل الفيديو مؤقتاً
    tmp_path = download_dropbox_video(file_path)
    if not tmp_path:
        return False, 'فشل تحميل الفيديو من Dropbox'
    try:
        ...
        result = r.json()
        if 'id' in result:
            logger.info(f"Video posted OK: {result['id']}")
            # سجّل أن هذه الصفحة نشرت الفيديو
            mark_video_used_today(file_path)
            mark_video_published_by_page(file_path, page_id)
            # احذف الفيديو فقط لو نُشر على كل الصفحات النشطة
            if should_delete_video_now(file_path, page_id):
                logger.info(f"All pages published this video — deleting from Dropbox: {file_path}")
                delete_dropbox_video(file_path)
                mark_video_deleted_in_tracker(file_path)
            else:
                logger.info(f"Video kept in Dropbox — waiting for other pages to publish it")
            return True, result['id']
        err = result.get('error', {}).get('message', 'خطأ في رفع الفيديو')
        return False, err
    except requests.Timeout:
        return False, 'انتهت مهلة الرفع'
    except Exception as e:
        ...
        if tmp_path and os.path.exists(tmp_path):
            os.remove(tmp_path)
            logger.info("Temp video deleted")
...
def get_prompt_for_type(post_type, topic, personality='mixed', seasonal_ctx=None):
    ...
    prompts = {
        ...
        # 💰 مالي وعملي
        'money_tip':          f'💰 اكتب منشور "نصيحة مالية يومية"\nنصيحة مالية عملية واحدة يطبقها الجميع\nالنصيحة بشكل بارز + شرح بسيط + كيف تطبقها اليوم\nاختم بـ: شاركنا نصيحتك المالية 👇\nالأسلوب: {p}',
        'home_business':      f'💼 اكتب منشور "فكرة مشروع من المنزل"\nفكرة مشروع حقيقية يمكن البدء بها برأس مال بسيط\nالفكرة + كيف تبدأ + كم تحتاج + كيف تربح\nاختم بـ: هل جربت مشروعاً من قبل؟ 👇\nالأسلوب: {p}',
        'save_money':         f'💵 اكتب منشور "كيف توفر المال"\nطريقة عملية لتوفير المال في الحياة اليومية\nالطريقة + كم توفر شهرياً + مثال حقيقي\nاختم بـ: شاركنا طريقتك في التوفير 👇\nالأسلوب: {p}',
        'money_mistake':      f'⚠️ اكتب منشور "خطأ مالي شائع احذره"\nخطأ مالي يقع فيه كثيرون ويكلفهم غالياً\nالخطأ + لماذا هو خطير + البديل الصحيح\nاختم بـ: هل وقعت في هذا الخطأ؟ 👇\nالأسلوب: {p}',
        'beginner_invest':    f'📈 اكتب منشور "استثمار مناسب للمبتدئين"\nفرصة استثمارية آمنة يمكن البدء بمبلغ بسيط\nالفرصة + المخاطر + كيف تبدأ + نصيحة مهمة\nاختم بـ: هل بدأت الاستثمار؟ 👇\nالأسلوب: {p}',
        # 🧠 تطوير الذات
        'life_habit':         f'✨ اكتب منشور "عادة تغير حياتك في 21 يوم"\nعادة بسيطة لو التزمت بها 21 يوماً ستغير حياتك\nالعادة + كيف تبدأها + التحدي\nاختم بـ: من معنا في التحدي؟ اكتب ✅ 👇\nالأسلوب: {p}',
        'book_review':        f'📚 اكتب منشور "كتاب يستحق قراءته"\nقدّم كتاباً مفيداً في تطوير الذات أو النجاح\nاسم الكتاب + المؤلف + أهم فكرة فيه + لمن هو مناسب\nاختم بـ: هل قرأته؟ شاركنا رأيك 👇\nالأسلوب: {p}',
        'weekly_skill':       f'🎯 اكتب منشور "مهارة يمكنك تعلمها هذا الأسبوع"\nمهارة عملية مفيدة يمكن تعلمها في أسبوع واحد\nالمهارة + كيف تتعلمها + أين تستفيد منها\nاختم بـ: ما المهارة التي تريد تعلمها؟ 👇\nالأسلوب: {p}',
        'success_person':     f'🏆 اكتب منشور "قصة نجاح شخص عادي"\nشخص عادي بدأ من الصفر وحقق نجاحاً حقيقياً\nبدايته + التحديات + نقطة التحول + النجاح + الدرس\nاختم بـ: ما الذي يلهمك في هذه القصة؟ 👇\nالأسلوب: {p}',
        'beat_laziness':      f'💪 اكتب منشور "كيف تتغلب على الكسل الآن"\nأسباب الكسل + 3 خطوات عملية للتغلب عليه فوراً\nكل خطوة واضحة وقابلة للتطبيق اليوم\nاختم بـ: ما الذي يوقفك الآن؟ شاركنا 👇\nالأسلوب: {p}',
        # ✨ كلمات وأشعار
        'motivational_word':  f'✨ اكتب منشور "كلمة تحفيزية مؤثرة"\nكلمة أو جملة واحدة عميقة تهز القلب وتشعل الهمة\nاكتبها بشكل بارز جداً + تأمل في معناها + كيف تؤثر في حياتك\nاختم بـ: أعد قراءتها ببطء 🤍\nالأسلوب: {p}',
        'poetry_arabic':      f'🌹 اكتب منشور "شعر عربي جميل"\nأبيات شعرية من كبار الشعراء العرب (المتنبي، نزار، درويش، الشابي)\nالأبيات بشكل بارز + اسم الشاعر + شرح الصورة الشعرية + ما تعنيه لك\nاختم بسؤال: ما البيت الذي يسكن في قلبك؟ 👇\nالأسلوب: {p}',
        'wisdom_deep':        f'🧠 اكتب منشور "حكمة للعقل والرزانة"\nحكمة عميقة من فيلسوف أو عالم أو حكيم عربي\nالحكمة بشكل بارز + من قالها + شرح معناها العميق + كيف تطبقها\nاختم بـ: من يتأمل فيها؟ 👇\nالأسلوب: {p}',
        'life_quote':         f'💫 اكتب منشور "اقتباس عن الحياة"\nاقتباس مؤثر عن الحياة والوجود والإنسان\nالاقتباس بشكل بارز + من قاله + تأمل فيه + سؤال: ماذا يعني لك؟\nالأسلوب: {p}',
        'heart_words':        f'🤍 اكتب منشور "كلمات من القلب"\nكلمات دافئة تخاطب القارئ مباشرة وتلمس قلبه\nاكتب كأنك تكلم صديقاً عزيزاً يمر بوقت صعب\nاختم بـ: أنت لست وحدك 🤍\nالأسلوب: {p}',
        # 🌙 قصص وروايات
        'mystery_story':      f'🌙 اكتب قصة غامضة مثيرة ومشوقة\nابدأ بمشهد يثير الفضول فوراً + أحداث متصاعدة + لحظة مفصلية\nنهاية مفاجئة أو مفتوحة تجعل القارئ يريد المزيد\nاختم بـ: ما الذي تتوقعه؟ 👇\nالأسلوب: {p}',
        'serial_story':       f'📖 اكتب الجزء التالي من رواية متسلسلة\nابدأ بـ: 📖 الجزء الجديد ✨\nتذكير سريع بما سبق + أحداث جديدة مثيرة + نهاية مفتوحة تترقب\nاختم بـ: الجزء القادم قريباً... من يتابع؟ 🔥\nالأسلوب: {p}',
        'romantic_story':     f'💕 اكتب قصة رومانسية جميلة ومؤثرة\nقصة حب واقعية تلامس القلب + تفاصيل حية + مشاعر صادقة\nلحظة مؤثرة تجعل القارئ يبتسم أو يتأثر\nاختم بـ: أيهما يشبه قصتك؟ 💕\nالأسلوب: {p}',
        'horror_lite':        f'👻 اكتب قصة رعب خفيفة مثيرة\nجو غامض + أحداث تبني التوتر ببطء + لحظة مفاجأة\nليست مرعبة جداً بل مثيرة للفضول\nاختم بـ: هل تصدق أن هذا حدث؟ 👀\nالأسلوب: {p}',
        'folk_tale':          f'🏺 اكتب حكاية شعبية عربية أصيلة\nحكاية من التراث العربي فيها حكمة + أحداث مشوقة + شخصيات حية\nأسلوب الجدة التي تحكي لأحفادها\nاختم بـ: وفي الحكاية عبرة لمن يتأمل 🌙\nالأسلوب: {p}',
        # 🧩 ألغاز وتحديات
        'riddle_daily':       f'🧩 اكتب منشور "لغز اليوم"\nلغز ذكي يحتاج تفكيراً + اكتبه بأسلوب مثير للفضول\nاختم بـ: الجواب في التعليقات بعد ساعة! ⏰\nاكتب الجواب في نهاية المنشور مع تحذير: SPOILER ⚠️\nالأسلوب: {p}',
        'challenge_week':     f'🎯 اكتب منشور "تحدي الأسبوع"\nتحدٍّ عملي بسيط يمكن لأي شخص فعله خلال أسبوع\nالتحدي واضح + كيف تنفذه + كيف تشارك نتيجتك\nاختم بـ: من معنا في التحدي؟ اكتب ✅ 👇\nالأسلوب: {p}',
        'quiz_question':      f'❓ اكتب منشور "سؤال اختبار معلومات"\nسؤال معلومات ثقافية مثير وغير متوقع\n3 خيارات واضحة أ/ب/ج\nاختم بـ: ما إجابتك؟ صوّت الآن! 👇\nثم اكتب الجواب الصحيح مع شرح مبسط\nالأسلوب: {p}',
        'complete_story':     f'✍️ اكتب منشور "أكمل القصة"\nابدأ قصة مشوقة وتوقف عند لحظة حرجة\nاكتب 3-4 أسطر فقط تثير الفضول\nاختم بـ: أكمل القصة في التعليقات! 👇 سننشر أفضل نهاية\nالأسلوب: {p}',
        'who_said':           f'🎭 اكتب منشور "من قال هذا؟"\nاكتب اقتباساً مشهوراً دون ذكر قائله\nالاقتباس بشكل بارز + اكتب 3 خيارات أحدها صحيح\nاختم بـ: خمّن من قاله! الجواب في التعليقات 👇\nثم اكشف الجواب مع قصة قصيرة عن صاحبه\nالأسلوب: {p}',
...
def publish_scheduled_post(page_id_str, schedule_id):
    ...
    # فيديو من المكتبة؟
    if post_type == '🎬 فيديو من المكتبة':
        # مجلد مخصص للموعد أو للصفحة
        custom_folder = schedule.get('dropbox_folder') or page.get('dropbox_folder') or None
        success, result = post_video_from_library(
            page['id'], page['access_token'], page['page_id'],
            page.get('topic','عام'), personality, custom_folder
        )
        mode = '🎬'
        message = f"✅ {mode} فيديو من المكتبة نُشر بنجاح" if success else f"❌ فشل الفيديو: {result}"
        add_log(page['name'], 'success' if success else 'error', message)
        update_stats(success, '🎬 فيديو')
        update_weekly_stats(page['name'], 'video', success)
        return
    ...
    add_log(page['name'], 'success' if success else 'error', message, actual_type)
...
def publish_page(page_id):
    ...
    # فيديو من المكتبة
    if post_type == '🎬 فيديو من المكتبة':
        custom_folder = data.get('dropbox_folder') or page.get('dropbox_folder') or None
        success, result = post_video_from_library(
            page['id'], page['access_token'], page['page_id'],
            page.get('topic','عام'), personality, custom_folder
        )
        add_log(page['name'], 'success' if success else 'error',
                f"{'✅' if success else '❌'} 🎬 فيديو من المكتبة")
        update_stats(success, 'video')
        return jsonify({'success': success, 'result': result, 'content': '🎬 فيديو', 'type': 'video'})
    ...
    type_name = POST_TYPES.get(actual_type, actual_type)
    mode = '🖼️' if use_image else '📝'
    add_log(page['name'],'success' if success else 'error',f"{'✅' if success else '❌'} {mode} ({type_name}): {content[:60]}...", actual_type)
    update_stats(success, actual_type)
    update_weekly_stats(page['name'], actual_type, success)
...
def publish_all():
    data = request.json or {}
    forced_type = data.get('post_type', '')  # فئة محددة من المستخدم (اختياري)
    pages = load_json(PAGES_FILE, [])
    results = []
    now_hour = datetime.now(pytz.timezone('Asia/Riyadh')).hour
    ...
    for page in pages:
        ...
        # حدد نوع البوست:
        # ١. لو المستخدم حدد فئة — استخدمها
        # ٢. لو في موعد مجدول للساعة الحالية — استخدمه
        # ٣. غير ذلك — دوّر على كل المواعيد بالترتيب
        if forced_type:
            post_type = forced_type
        elif schedules:
            # ابحث عن موعد مناسب للوقت الحالي
            current_schedule = next(
                (s for s in schedules if int(s['time'].split(':')[0]) == now_hour),
                None
            )
            if current_schedule:
                post_type = current_schedule.get('post_type', 'tips')
            else:
                # اختر موعداً بالتناوب حسب اليوم
                day_idx = datetime.now(pytz.timezone('Asia/Riyadh')).weekday()
                post_type = schedules[day_idx % len(schedules)].get('post_type', 'tips')
        else:
            post_type = 'islamic_wisdom'

        # نشر حسب النوع
        try:
            if post_type == '🎬 فيديو من المكتبة':
                custom_folder = page.get('dropbox_folder') or None
                success, result = post_video_from_library(
                    page['id'], page['access_token'], page['page_id'],
                    topic, personality, custom_folder
                )
                mode = '🎬'
                log_msg = f"{'✅' if success else '❌'} 🎬 فيديو: {result if not success else 'تم النشر'}"
                add_log(page['name'], 'success' if success else 'error', log_msg, 'video')
            else:
                content, actual_type = generate_content(topic, post_type, page['name'], page['id'], personality)
                if use_image:
                    success, result = post_image_to_facebook(page['page_id'], page['access_token'], content, actual_type)
                    mode = '🖼️'
                else:
                    ...
                    mode = '📝'
                type_name = POST_TYPES.get(actual_type, actual_type)
                log_msg = f"{'✅' if success else '❌'} {mode} ({type_name}): {content[:50]}..."
                add_log(page['name'], 'success' if success else 'error', log_msg, actual_type)
                update_stats(success, actual_type)
                update_weekly_stats(page['name'], actual_type, success)
        except Exception as e:
            success = False
            result = str(e)
            add_log(page['name'], 'error', f"❌ خطأ: {str(e)[:80]}")

        results.append({'page': page['name'], 'success': success, 'type': post_type})
...
def analyze_best_times(page_name=None):
    """تحليل أفضل أوقات النشر بالـ AI بناءً على البيانات"""
    analytics = load_json(ANALYTICS_FILE, {})
    logs = load_json(LOGS_FILE, [])
    if not logs:
        return None
    # حساب نسبة النجاح لكل ساعة
    hour_stats = {}
    for log in logs:
        if page_name and log.get('page') != page_name:
            continue
        hour = log.get('hour')
        if hour is None:
            continue
        if hour not in hour_stats:
            hour_stats[hour] = {'success': 0, 'fail': 0, 'total': 0}
    ...
    for h, s in hour_stats.items():
        s['rate'] = round((s['success'] / s['total']) * 100, 1) if s['total'] > 0 else 0
    # أفضل 5 ساعات
    best = sorted(hour_stats.items(), key=lambda x: (x[1]['rate'], x[1]['total']), reverse=True)[:5]
    worst = sorted(hour_stats.items(), key=lambda x: (x[1]['rate'], x[1]['total']))[:3]
    return {
        'best_hours': [{'hour': h, **s} for h, s in best],
        'worst_hours': [{'hour': h, **s} for h, s in worst],
        'total_posts': sum(s['total'] for s in hour_stats.values()),
        'overall_rate': round(sum(s['success'] for s in hour_stats.values()) /
                              max(sum(s['total'] for s in hour_stats.values()), 1) * 100, 1)
    }

def get_ai_schedule_recommendation(page_id=None, page_name=None):
    """الـ AI يحلل البيانات ويقترح جدولاً محسّناً"""
    settings = load_json(SETTINGS_FILE, {})
    api_key = settings.get('groq_api_key', '').strip()
    analysis = analyze_best_times(page_name)
    if not analysis or analysis['total_posts'] < 10:
        return None, 'تحتاج على الأقل 10 بوستات لبدء التحليل'
    if not api_key:
        return analysis, None
    try:
        best = analysis['best_hours']
        worst = analysis['worst_hours']
        days_ar = ['الإثنين','الثلاثاء','الأربعاء','الخميس','الجمعة','السبت','الأحد']
        prompt = (
            'أنت محلل بيانات متخصص في تحسين التفاعل على فيسبوك.\n'
            'بناءً على بيانات النشر التالية، اقترح أفضل 7 أوقات للنشر يومياً:\n\n'
            'أفضل الأوقات (نسبة نجاح عالية):\n' +
            '\n'.join([f"- الساعة {h['hour']}:00 — نجاح {h['rate']}% من {h['total']} بوست" for h in best]) +
            '\n\nأسوأ الأوقات:\n' +
            '\n'.join([f"- الساعة {h['hour']}:00 — نجاح {h['rate']}% فقط" for h in worst]) +
            f'\n\nإجمالي البوستات المحللة: {analysis["total_posts"]}\n'
            'معدل النجاح الكلي: ' + str(analysis['overall_rate']) + '%\n\n'
            'اقترح:\n'
            '1. أفضل 7 أوقات للنشر مع السبب\n'
            '2. الأوقات التي يجب تجنبها\n'
            '3. توصية واحدة لتحسين التفاعل\n'
            'الرد باللغة العربية فقط وبشكل مختصر وعملي.'
        )
        r = requests.post("https://api.groq.com/openai/v1/chat/completions",
            headers={"Authorization": f"Bearer {api_key}", "Content-Type": "application/json"},
            json={"model": "llama-3.3-70b-versatile",
...
@app.route('/api/video_library/status', methods=['GET'])
def video_library_status():
    spaces = load_dropbox_spaces()
    if not spaces:
        return jsonify({'online': False, 'configured': False, 'error': 'لم يتم إضافة أي مساحة Dropbox'})
    try:
        all_videos = list_all_dropbox_videos()
        progress = load_video_progress()
        daily = load_daily_videos()
        spaces_info = []
        for s in spaces:
            vids = list_videos_from_space(s)
            spaces_info.append({'id': s['id'], 'name': s['name'], 'count': len(vids)})
        return jsonify({
            'online': True,
            'configured': True,
            ...
            'used_today': len(daily.get('used_paths', []))
        })
    except Exception as e:
        return jsonify({'online': False, 'configured': True, 'error': str(e)})

@app.route('/api/video_library/videos', methods=['GET'])
def video_library_videos():
    try:
        videos = list_all_dropbox_videos()
        return jsonify({'success': True, 'count': len(videos),
            'videos': [{'name': v['name'], 'size': v.get('size',0),
                        'space': v.get('_space_id','main')} for v in videos[:30]]})
    except Exception as e:
        return jsonify({'success': False, 'error': str(e)})

@app.route('/api/video_library/spaces', methods=['GET'])
def get_spaces():
    spaces = load_dropbox_spaces()
    safe = [{'id':s['id'],'name':s['name'],'folder':s.get('folder','/videos'),
             'added_at':s.get('added_at','')} for s in spaces]
    return jsonify(safe)

@app.route('/api/video_library/spaces', methods=['POST'])
def add_space():
    data = request.json or {}
    ...
    folder = data.get('folder','/videos').strip()
    if not all([name, app_key, app_secret, refresh_token]):
        return jsonify({'success': False, 'error': 'أكمل جميع الحقول'})
    # اختبر التوكن
    test_space = {'app_key':app_key,'app_secret':app_secret,'refresh_token':refresh_token,
                  'folder':folder,'_token_cache':{'token':'','expires':0}}
    token = get_space_token(test_space)
    if not token:
        return jsonify({'success': False, 'error': 'فشل التحقق من التوكن — تأكد من البيانات'})
    space_id = add_dropbox_space(name, app_key, app_secret, refresh_token, folder)
    return jsonify({'success': True, 'id': space_id})

@app.route('/api/video_library/spaces/<space_id>', methods=['DELETE'])
def delete_space(space_id):
    if space_id == 'main':
        return jsonify({'success': False, 'error': 'لا يمكن حذف المساحة الرئيسية'})
    spaces = load_json(DROPBOX_SPACES_FILE, [])
    spaces = [s for s in spaces if s.get('id') != space_id]
    save_json(DROPBOX_SPACES_FILE, spaces)
    return jsonify({'success': True})

@app.route('/api/video_library/exchange_token', methods=['POST'])
def exchange_dropbox_token():
    """تحويل authorization code لـ refresh token دائم"""
    data = request.json or {}
    code = data.get('code','').strip()
    app_key = data.get('app_key','').strip()
    app_secret = data.get('app_secret','').strip()
    if not all([code, app_key, app_secret]):
        return jsonify({'success': False, 'error': 'أكمل جميع الحقول'})
    try:
        r = requests.post('https://api.dropbox.com/oauth2/token',
            data={
        ...
        return jsonify({'success': False, 'error': result.get('error_description', 'فشل التحويل')})
    except Exception as e:
        return jsonify({'success': False, 'error': str(e)})
...
def get_schedule_templates():
    result = {}
    for k, v in SCHEDULE_TEMPLATES.items():
        hours = v['hours']
        video_slots = sum(1 for _,c in hours if c == '🎬 فيديو من المكتبة')
        result[k] = {
            'desc': v['desc'],
            'hours_count': len(hours),
            'max_videos': video_slots,
            'text_posts': len(hours) - video_slots
        }
...
def apply_template(page_id):
    ...
    video_count = int(data.get('video_count', 5))   # عدد الفيديوهات المطلوبة
    dropbox_folder = data.get('dropbox_folder', '').strip()  # مجلد Dropbox مخصص
    ...
    offset = page_idx % 6
    all_hours = template['hours']
    # فلتر الفيديوهات حسب video_count المطلوب
    video_slots = [(h,c) for h,c in all_hours if c == '🎬 فيديو من المكتبة']
    text_slots  = [(h,c) for h,c in all_hours if c != '🎬 فيديو من المكتبة']
    # اختر العدد المطلوب من الفيديوهات
    selected_videos = video_slots[:video_count]
    # دمج وترتيب
    final_hours = sorted(text_slots + selected_videos, key=lambda x: x[0])
    # دوّر حسب offset
    rotated = final_hours[offset:] + final_hours[:offset]
    ...
    for i, (hour, category) in enumerate(rotated):
        ...
        # لو فيديو وعنده مجلد مخصص
        if category == '🎬 فيديو من المكتبة' and dropbox_folder:
            sched['dropbox_folder'] = dropbox_folder
    ...
    if dropbox_folder:
        pages[page_idx]['dropbox_folder'] = dropbox_folder
    save_json(PAGES_FILE, pages)
    setup_scheduler()
    total_videos = sum(1 for _,c in rotated if c == '🎬 فيديو من المكتبة')
    return jsonify({'success': True, 'schedules_added': len(schedules),
                    'videos_in_schedule': total_videos, 'template': template_name})
...
def get_analytics():
    page_name = request.args.get('page', None)
    analysis = analyze_best_times(page_name)
    if not analysis:
        return jsonify({'success': False, 'error': 'لا توجد بيانات كافية بعد — انشر على الأقل 10 بوستات'})
    return jsonify({'success': True, **analysis})

@app.route('/api/analytics/recommend', methods=['GET'])
def get_ai_recommendation():
    page_id = request.args.get('page_id', None)
    page_name = request.args.get('page_name', None)
    analysis, recommendation = get_ai_schedule_recommendation(page_id, page_name)
    if not analysis:
        return jsonify({'success': False, 'error': recommendation or 'لا توجد بيانات كافية'})
    return jsonify({
        'success': True,
        'analysis': analysis,
