...
SCHEDULE_TEMPLATES = {
    "📖 جدول القرآن": {
        "desc": "يركز على القرآن والتفسير + 5 فيديوهات يومياً",
        "hours": [
            (0,  "🤲 أدعية قصيرة مؤثرة"),
            (1,  "📖 القرآن الكريم"),
            (2,  "📖 القرآن الكريم"),
    ...
    "⚔️ جدول البطولات": {
        "desc": "يركز على الفتوحات والسيرة + 5 فيديوهات يومياً",
        "hours": [
            (0,  "🤲 أدعية قصيرة مؤثرة"),
            (1,  "⚖️ حكم وأمثال"),
            (2,  "💬 كلمات معبرة"),
    ...
    "🤲 جدول الروحانيات": {
        "desc": "يركز على الأذكار والأدعية + 5 فيديوهات يومياً",
        "hours": [
            (0,  "🤲 الأذكار والأدعية"),
            (1,  "💌 رسائل إيمانية"),
            (2,  "🤲 أدعية قصيرة مؤثرة"),
    ...
    "💡 جدول التحفيز": {
        "desc": "يركز على التحفيز والنجاح + 5 فيديوهات يومياً",
        "hours": [
            (0,  "🤲 أدعية قصيرة مؤثرة"),
            (1,  "⚖️ حكم وأمثال"),
            (2,  "💬 كلمات معبرة"),
    ...
    "📚 جدول العلم": {
        "desc": "يركز على الفقه والحديث + 5 فيديوهات يومياً",
        "hours": [
            (0,  "🤲 أدعية قصيرة مؤثرة"),
            (1,  "⚖️ حكم وأمثال"),
            (2,  "📖 القرآن الكريم"),
    ...
    "🌙 جدول المتنوع": {
        "desc": "يشمل جميع الفئات بتوازن + 5 فيديوهات يومياً",
        "hours": [
            (0,  "🤲 أدعية قصيرة مؤثرة"),
            (1,  "⚖️ حكم وأمثال"),
            (2,  "💬 كلمات معبرة"),
