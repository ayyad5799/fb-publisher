...
def get_dropbox_token():
    ...
    if _dropbox_access_token['token'] and time.time() < _dropbox_access_token['expires'] - 300:
    ...
    try:
        ...
        if 'access_token' in data:
            ...
            _dropbox_access_token['expires'] = t.time() + data.get('expires_in', 14400)
...
def list_dropbox_videos():
    ...
    try:
        headers = {'Authorization': f'Bearer {get_dropbox_token()}', 'Content-Type': 'application/json'}
