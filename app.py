...
POST_CATEGORIES = {
    '📖 القرآن الكريم': ['quran_ayah','quran_tafseer','quran_recitation','quran_khatma'],
    '🕌 الدروس والمحاضرات': ['friday_khutba','fiqh_lesson','scholar_lecture'],
    '👳 قصص الأنبياء': ['prophet_story','prophet_moses','prophet_yusuf','prophet_ibrahim','prophet_miracles','prophet_lessons'],
    '⚔️ قصص الصحابة': ['sahabi_story','sahabi_heroism','sahabi_islam','sahabi_moment'],
    '😢 قصص مؤثرة ومبكية': ['story_tawba','story_good_end','story_karama'],
    '💫 قصص من الحياة': ['story_divine_gift','story_duaa_answered','story_religious_exp'],
    '🌅 أذكار اليوم': ['adhkar_morning','adhkar_evening','adhkar_home','adhkar_sleep','morning_adhkar','evening_adhkar'],
    '🤲 أدعية المناسبات': ['duaa_hardship','duaa_rizq','duaa_ramadan_friday','occasion_duaa','tasbih'],
    '✨ أدعية قصيرة مؤثرة': ['duaa_short','duaa_healing','duaa_parents'],
    '✨ المحتوى التحفيزي الديني': ['islamic_wisdom','motivation','inspiration_quote','success_story','life_change'],
    '📚 الفتاوى والأحكام': ['fatwa','ibadah_ruling','muamalat'],
    '🌙 المناسبات الدينية': ['ramadan','eid','hajj_umrah'],
    '📖 قصص وحكايات': ['story_suspense','story_romance','story_horror','story_personal','story_today','story_serial'],
    '😂 كوميدي': ['meme','comedy_sketch'],
    '🎭 دراما وتشويق': ['drama_mystery','truth_or_lie'],
    '🌍 وثائقي': ['weird_facts','country_culture','history_simple'],
    '💡 متنوع': ['tips','offer','question','fact','wisdom','poet_quote'],
}
...
def get_smart_post_type(page_id, requested_type):
    if requested_type in ['quran_tafseer','quran_ayah','quran_recitation','quran_khatma','friday_khutba','morning_adhkar','evening_adhkar','ramadan','eid','hajj_umrah']: return requested_type
...
def get_prompt_for_type(post_type, topic, personality='mixed', seasonal_ctx=None):
    ...
    prompts = {
        ...
        'wisdom': f'اكتب منشور عن حكمة لأحد عظماء الأدب العربي (اختر من: نجيب محفوظ، جبران خليل جبران، المتنبي، أحمد شوقي، طه حسين، الشابي، نزار قباني)\n💡 الحكمة + اسم قائلها + شرحها + تطبيقها + سؤال تفاعلي\nالموضوع: {topic}، الأسلوب: {pname}',
        'poet_quote': f'اكتب منشور عن بيت شعر من الأدب العربي (اختر من: المتنبي، نزار قباني، محمود درويش، الشابي، أحمد شوقي)\n🎭 البيت الشعري + اسم الشاعر + شرحه + رسالته\nالموضوع: {topic}، الأسلوب: {pname}',
